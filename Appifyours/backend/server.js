...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/joyboy_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '695cbee75839fc1226cc7444',
      shopName: 'Joyboy',
...
app.listen(PORT, () => {
  console.log(`Joyboy Backend Server running on port ${PORT}`);
});
